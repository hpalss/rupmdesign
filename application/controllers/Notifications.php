...
class Notifications extends MY_Controller {
    ...
    function count_notifications() {
        ...
        $newEstimates = $this->Estimate_requests_model->count();
        echo json_encode(array("success" => true, 'total_notifications' => $notifiations,"estimateRequests"=>$newEstimates));
    }
    ...
    function set_notification_status_as_read($notification_id = 0) {
        if ($notification_id) {
            ...
            echo json_encode(array("success" => true, 'message' => lang('marked_all_notifications_as_read')));
        }
    }
