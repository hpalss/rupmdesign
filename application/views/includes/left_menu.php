<div id="sidebar" class="box-content ani-width collapsed">
    <div id="sidebar-scroll">
      <div class="sidebarUserCol">
        <span class="avatar-xs avatar pull-left mt-5 mr10" >
            <img alt="..." src="<?php echo get_avatar($this->login_user->image); ?>">
        </span>
        <span class="sidebar-user-name"><?php echo $this->login_user->first_name . " " . $this->login_user->last_name; ?></span>
      </div>
        <ul class="" id="sidebar-menu">
            ...
            if ($this->login_user->user_type == "staff") {
                ...
                if (get_setting("module_estimate") && get_setting("module_estimate_request") && ($this->login_user->is_admin || $access_estimate)) {
                    ...
                    $sidebar_menu[] = array("name" => "estimates", "url" => "estimates", "class" => "fa-file estimate-main-tab",
                        "submenu" => array(
                            array("name" => "estimate_list", "url" => "estimates"),
                            array("name" => "estimate_requests", "url" => "estimate_requests","class"=>"estimate-sub-menu"),
                ...
                if ($this->login_user->role_id==1) {
                    $sidebar_menu[] = array("name" => "bidding", "url" => "bidding", "class" => "fa-file estimate-main-tab");
                }
