...
<?php
$task_link = anchor(get_uri("projects/view/$model_info->project_id/tasks?task=" . $model_info->id), '<i class="fa fa-external-link task-link-btn"></i>', array("target" => "_blank", "class" => "p15"));
?>
