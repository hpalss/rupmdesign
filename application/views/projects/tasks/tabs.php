...
<li class="js-cookie-tab <?php echo ($active_tab == 'calendar') ? 'active' : ''; ?>" data-tab="tasks_calendar"><a href="<?php echo_uri('projects/all_tasks_calendar/'); ?>" ><?php echo lang('calendar'); ?></a></li>
