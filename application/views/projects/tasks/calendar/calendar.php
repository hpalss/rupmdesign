...
<div class="page-title clearfix">
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("projects/task_view"), "", array("class" => "hide", "id" => "show_event_hidden", "data-post-id" => "", "data-post-cycle" => "0", "data-post-editable" => "1", "title" => lang('event_details'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#event-calendar").fullCalendar({
            ...
            events: {
            url: "<?php echo_uri("projects/task_data/"); ?>",
