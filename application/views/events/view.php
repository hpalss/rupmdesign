    ...
    <div class="table-responsive mb15">
        <div class="col-md-12">
            <h4 class="mt0">
                ...
                if (isset($model_info->share_with) && !$model_info->share_with) {
        ...
        <?php if (isset($model_info->company_name) && $model_info->company_name && $this->login_user->user_type != "client") { ?>
        ...
        <?php if (isset($model_info->location ) && $model_info->location) { ?>
