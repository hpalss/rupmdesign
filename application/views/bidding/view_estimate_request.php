    ...
    <div style="max-width: 1000px; margin: auto;">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-4">
                        <?php if (!in_array($model_info->status, array("accepted","canceled","rejected"))): ?>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?=lang("actions")?></h3>
                            </div>
                            <div class="panel-body"> 
                                <?php $bidText = $bidding?lang("view_bid"):lang('send_bid'); ?>
                                <?php echo modal_anchor(get_uri("bidding/open_question_modal"), "<i class='fa fa-question'></i> " . lang('ask_question'), array("title" => lang('ask_question'), "data-post-view" => "details","class"=>"btn btn-warning", "data-post-id" => $model_info->id)); ?>
                                <?php echo modal_anchor(get_uri("bidding/open_bidding_modal"), "<i class='fa fa-plane'></i> " . $bidText, array("title" => lang('bidding_requests'), "data-post-view" => "details","class"=>"btn btn-success", "data-post-id" => $model_info->id)); ?>
                            </div>
                        </div>
                        <?php endif ?>
                        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3 class="page-title mt15">  <?php echo lang('questions') ?></h3>
                <div class="table-responsive mt20 general-form">
                    <?php $this->load->view("bidding/questions", array("data"=>$questions,"estimate_id"=>$model_info->id))?>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#estimate-request-table").appTable({
            source: '<?php echo_uri("bidding/estimate_request_view/" . $model_info->id) ?>',
            order: [[1, "asc"]],
            hideTools: true,
            displayLength: 100,
            columns: [
