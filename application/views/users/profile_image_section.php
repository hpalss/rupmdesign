<div class="box">
    <div class="box-content w200 text-center profile-image">
        ...
        <?php } ?>
        <span class="avatar avatar-lg"><img id="profile-image-preview" src="<?php echo get_avatar($user_info->image); ?>" alt="..."><?=is_online($user_info->last_online)?></span> 
        <h4 class=""><?php echo $user_info->first_name . " " . $user_info->last_name; ?></h4>
        <p><?=lang("last_seen").time_elapsed_string($user_info->last_online) ?></p>
        <?php echo form_close(); ?>
    </div> 
