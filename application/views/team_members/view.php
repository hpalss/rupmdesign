...
<div id="page-content" class="clearfix">
        ...
        <div class="col-md-6 text-center cover-widget">
            <div class="row p20">
                ...
                if ($this->login_user->user_type!="client") {
                    count_bidding_widget($user_info->id);
                }
                ?> 
            </div>
        </div>
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <?php if ($estimate_requests && $this->login_user->user_type!="client") { ?>
            <li><a role="presentation" href="<?php echo_uri("team_members/estimate_requests/" . $user_info->id); ?>" data-target="#tab-estimate-request"><?php echo lang('estimate_requests'); ?></a></li>
        <?php } ?> 
    ...
    <div class="tab-content">
        ...
        <?php if ($this->login_user->user_type!="client"): ?>
            <div role="tabpanel" class="tab-pane fade" id="tab-estimate-request"></div>
        <?php endif ?>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        }else if (tab === "estimate_requests") {
            $("[data-target=#tab-estimate-request]").trigger("click");
        }
